      ...
      columnDefs : [
        ...
        },
        {
            ...
            cellTemplate: '<center>' +
               ...
               '<i title="{{\'BTN.VER\' | translate }}" class="fa fa-file-text fa-lg  faa-shake animated-hover"></i></a> ' +
               '<a ng-if="row.entity.FechaExpedicion && row.entity.Estado==true" class="editar" ng-click="grid.appScope.verCancelarResolucion(row)">' +
               '<i title="{{\'BTN.EDITAR\' | translate }}" class="fa fa-remove fa-lg  faa-shake animated-hover"></i></a> ' +
               ...
               '<i title="{{\'BTN.CONFIGURAR\' | translate }}" class="fa fa-refresh fa-lg faa-spin animated-hover"></i></a> ' +
               '</center>'
        }
      ]
    };
